...
const Closed1 = () => {
  ...
  const barData = [
    {value: jsonData.Clo1.count, frontColor: '#64CCC5'},
    {value: jsonData.Clo2.count, frontColor: '#BAE8D6'},
    {value: jsonData.Clo3.count, frontColor: '#64CCC5'},
    {value: jsonData.Clo4.count, frontColor: '#BAE8D6'},
    {value: jsonData.Clo5.count, frontColor: '#64CCC5'},
  ];
  ...
  return (
    <View style={[styles.newincident, styles.frameFlexBox1]}>
      ...
      <View style={[styles.frameGroup, styles.frameGroupFlexBox]}>
        <Text style={styles.textHeader}>{timeInterval} : Closed</Text>
      </View>
      <View style={[styles.newincidentInner, styles.frameGroupFlexBox]}>
        <View style={[styles.newgraphWrapper, styles.wrapperFlexBox1]}>
          <PieChart
            ...
            return <Text style={{fontSize: 50,color:"white"}}>{jsonData.countClosed}</Text>;
            }}
            />
        </View>
      </View>
      <View style={[styles.frameGroup1, styles.frameGroupFlexBox]}>
        <Text style={styles.textSubHeader}>TOP 5 Closed</Text>
      </View>
        ...
        <View style={[styles.newgraphtop5Wrapper, styles.wrapperFlexBox1]}>
          ...
          <View style={styles.textbargraphParent}>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Clo1.name !== null && jsonData.Clo1.count !== null
    ? `${jsonData.Clo1.name} : ${jsonData.Clo1.count}`
    : ''}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Clo2.name !== null && jsonData.Clo2.count !== null
    ? `${jsonData.Clo2.name} : ${jsonData.Clo2.count}`
    : ' '}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Clo3.name !== null && jsonData.Clo3.count !== null
    ? `${jsonData.Clo3.name} : ${jsonData.Clo3.count}`
    : ' '}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Clo4.name !== null && jsonData.Clo4.count !== null
    ? `${jsonData.Clo4.name} : ${jsonData.Clo4.count}`
    : ' '}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Clo5.name !== null && jsonData.Clo5.count !== null
    ? `${jsonData.Clo5.name} : ${jsonData.Clo5.count}`
    : ' '}
            </Text>
          </View>
        </View>
