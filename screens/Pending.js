...
const Pending = () => {
  ...
  const barData = [
    {value: jsonData.Ope1.count, frontColor: '#64CCC5'},
    {value: jsonData.Ope2.count, frontColor: '#BAE8D6'},
    {value: jsonData.Ope3.count, frontColor: '#64CCC5'},
    {value: jsonData.Ope4.count, frontColor: '#BAE8D6'},
    {value: jsonData.Ope5.count, frontColor: '#64CCC5'},
  ];
  ...
  return (
    <View style={[styles.newincident, styles.frameFlexBox1]}>
      ...
      <View style={[styles.frameGroup, styles.frameGroupFlexBox]}>
        <Text style={styles.textHeader}>{timeInterval} : Pending</Text>
      </View>
      <View style={[styles.newincidentInner, styles.frameGroupFlexBox]}>
        <View style={[styles.newgraphWrapper, styles.wrapperFlexBox1]}>
          <PieChart
            ...
            return <Text style={{fontSize: 50,color:"white"}}>{jsonData.countOngoing}</Text>;
            }}
            />
        </View>
      </View>
      <View style={[styles.frameGroup1, styles.frameGroupFlexBox]}>
        <Text style={styles.textSubHeader}>TOP 5 Pending</Text>
      </View>
        ...
        <View style={[styles.newgraphtop5Wrapper, styles.wrapperFlexBox1]}>
          ...
          <View style={styles.textbargraphParent}>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Ope1.name !== null && jsonData.Ope1.count !== null
    ? `${jsonData.Ope1.name} : ${jsonData.Ope1.count}`
    : ''}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Ope2.name !== null && jsonData.Ope2.count !== null
    ? `${jsonData.Ope2.name} : ${jsonData.Ope2.count}`
    : ' '}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Ope3.name !== null && jsonData.Ope3.count !== null
    ? `${jsonData.Ope3.name} : ${jsonData.Ope3.count}`
    : ' '}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Ope4.name !== null && jsonData.Ope4.count !== null
    ? `${jsonData.Ope4.name} : ${jsonData.Ope4.count}`
    : ' '}
            </Text>
            <Text style={[styles.textbargraphTypo, Platform.OS === 'ios' ? styles.iosText : null]}>
              {jsonData.Ope5.name !== null && jsonData.Ope5.count !== null
    ? `${jsonData.Ope5.name} : ${jsonData.Ope5.count}`
    : ' '}
            </Text>
          </View>
        </View>
