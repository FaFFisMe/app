...
const MTTR = () => {
  ...
  const processData = (data) => {
    ...
    if (data != null) {
      ...
      return counts.map((value, index) => ({ value, 
        ...
        frontColor: index == "0" || index == "4" ?  "#B22222" : "#FDA172",
        topLabelComponent: () => (
          <Text style={{color: 'orange', fontSize: 18, marginBottom: 6}}>{value}</Text>
        ),
  ...
  const lineData1 = processData(jsonData.TTRall);
      ...
      <View style={[styles.frameGroup, styles.frameGroupFlexBox]}>
          ...
          <View style={styles.frameView}>
            <View style={styles.mttdavghrWrapper}>
              <Text style={[styles.mttdavghr, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRavg).hours}
              </Text>
            </View>
            ...
            <View style={styles.mttdavgmWrapper}>
              <Text style={[styles.mttdavgm, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRavg).minutes}
              </Text>
            </View>
            ...
            <View style={[styles.mttdavgsWrapper, styles.wrapperPosition]}>
              <Text style={[styles.mttdavgs, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRavg).seconds}
              </Text>
            </View>
        ...
        <View style={[styles.frameParent1, styles.frameParentLayout]}>
          ...
          <View style={styles.frameView}>
            <View style={styles.mttdavghrWrapper}>
              <Text style={[styles.mttdavghr, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRmax).hours}
              </Text>
            </View>
            <View style={[styles.wrapper, styles.wrapperPosition]}>
              <Text style={styles.textTypo}>:</Text>
            ...
            <View style={styles.mttdavgmWrapper}>
              <Text style={[styles.mttdavgm, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRmax).minutes}
              </Text>
            </View>
            ...
            <View style={[styles.mttdavgsWrapper, styles.wrapperPosition]}>
              <Text style={[styles.mttdavgs, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRmax).seconds}
              </Text>
            </View>
          </View>
        </View>
        <View style={[styles.frameParent3, styles.frameParentLayout]}>
          ...
          <View style={styles.frameView}>
            <View style={styles.mttdavghrWrapper}>
              <Text style={[styles.mttdavghr, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRmin).hours}
              </Text>
            </View>
            <View style={[styles.wrapper, styles.wrapperPosition]}>
              <Text style={styles.textTypo}>:</Text>
            ...
            <View style={styles.mttdavgmWrapper}>
              <Text style={[styles.mttdavgm, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRmin).minutes}
              </Text>
            </View>
            <View style={[styles.frame, styles.framePosition]}>
              <Text style={styles.textTypo}>:</Text>
            ...
            <View style={[styles.mttdavgsWrapper, styles.wrapperPosition]}>
              <Text style={[styles.mttdavgs, styles.mttdavgmTypo]}>
                {convertMillisToTime(jsonData && jsonData.TTRmin).seconds}
              </Text>
            </View>
